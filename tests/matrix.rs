...
fn test_load_invalid_not_found_csv() {
    let _w: Matrix<i32> =
        Matrix::from_csv("tests/random_file.csv", false).unwrap();
}
...
fn test_load_invalid_format_csv() {
    let _w: Matrix<i32> =
        Matrix::from_csv("tests/matrix_invalid_empty.csv", false).unwrap();
}
...
fn test_load_invalid_element() {
    let _w: Matrix<i32> =
        Matrix::from_csv("tests/matrix_invalid_element.csv", false).unwrap();
}
...
fn test_load_invalid_element_different_data_type_expected_u32() {
    let _w: Matrix<u32> =
        Matrix::from_csv("tests/matrix_valid_without_header.csv", false)
            .unwrap();
}
...
fn test_load_invalid_inconsistent_column() {
    let _w: Matrix<u32> =
        Matrix::from_csv("tests/matrix_invalid_inconsistent_column.csv", false)
            .unwrap();
}
